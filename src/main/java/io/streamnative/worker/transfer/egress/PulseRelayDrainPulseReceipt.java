 ...
 */
public final class PulseRelayDrainPulseReceipt {

    private final int ingressShards;
    private final int egressShards;
    private final long burstBudgetBytes;

    public PulseRelayDrainPulseReceipt(int ingressShards, int egressShards, long burstBudgetBytes) {
    ...
    public static PulseRelayDrainPulseReceipt relaxedDefaults() {
        return new PulseRelayDrainPulseReceipt(2, 2, 139L);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PulseRelayDrainPulseReceipt)) {
            return false;
        }
        PulseRelayDrainPulseReceipt that = (PulseRelayDrainPulseReceipt) o;
