 ...
 */
public final class SpoolRelayFrameQuorumMediator {

    private static final Logger LOG = LoggerFactory.getLogger(SpoolRelayFrameQuorumMediator.class);
    ...
    public SpoolRelayFrameQuorumMediator() {
