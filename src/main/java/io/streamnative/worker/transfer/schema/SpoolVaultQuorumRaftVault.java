 ...
 */
public final class SpoolVaultQuorumRaftVault {

    private final int ingressShards;
    private final int egressShards;
    private final long burstBudgetBytes;

    public SpoolVaultQuorumRaftVault(int ingressShards, int egressShards, long burstBudgetBytes) {
    ...
    public static SpoolVaultQuorumRaftVault relaxedDefaults() {
        return new SpoolVaultQuorumRaftVault(2, 2, 155L);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SpoolVaultQuorumRaftVault)) {
            return false;
        }
        SpoolVaultQuorumRaftVault that = (SpoolVaultQuorumRaftVault) o;
