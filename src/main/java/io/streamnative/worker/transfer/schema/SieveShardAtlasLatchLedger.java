 ...
 */
public final class SieveShardAtlasLatchLedger {

    private static final Logger LOG = LoggerFactory.getLogger(SieveShardAtlasLatchLedger.class);
    ...
    public SieveShardAtlasLatchLedger() {
