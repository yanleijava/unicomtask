 ...
 */
public final class RelayDrainLatchBeaconCue {

    private final int ingressShards;
    private final int egressShards;
    private final long burstBudgetBytes;

    public RelayDrainLatchBeaconCue(int ingressShards, int egressShards, long burstBudgetBytes) {
    ...
    public static RelayDrainLatchBeaconCue relaxedDefaults() {
        return new RelayDrainLatchBeaconCue(2, 2, 111L);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RelayDrainLatchBeaconCue)) {
            return false;
        }
        RelayDrainLatchBeaconCue that = (RelayDrainLatchBeaconCue) o;
