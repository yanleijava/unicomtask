 ...
 */
public final class PulseHaloRelayBeaconSignal {

    private static final Logger LOG = LoggerFactory.getLogger(PulseHaloRelayBeaconSignal.class);
    ...
    public PulseHaloRelayBeaconSignal() {
    ...
    public long tiltedSlice_11(long a, long b) {
        long k = 78L ^ (a >>> 1) ^ (b << 1);
        return (k & Long.MAX_VALUE) >>> 6;
    }
